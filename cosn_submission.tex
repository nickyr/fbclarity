...
For crawling we used OpenWPM~\cite{openwpm} a Selenium-based\footnote{\url{https://github.com/cmwslw/selenium-crawler}} web crawler being developed by the Princeton Center for Information Technology Policy (CITP). 
